...
process run_file_download_stat {
    ...
    input:
    path file_download_counts  // Input the file generated by analyze_parquet_files
...
workflow {
    ...
    run_file_download_stat(analyze_parquet_files.out.file_download_counts)
